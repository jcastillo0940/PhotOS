                            ...
                            {(project.photos || []).length > 0 ? project.photos.map((photo) => (
                                <article key={photo.id} className="overflow-hidden rounded-[1.5rem] border border-[#ece5d8] bg-white shadow-sm transition hover:shadow-md">
                                    <div className="relative group">
                                        ...
                                        <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-900/60 to-transparent p-4 opacity-0 transition-opacity group-hover:opacity-100">
                                    ...
                                    <div className="p-4 space-y-4">
                                        ...
                                        <label className="flex cursor-pointer items-center justify-between rounded-xl border border-[#e6e0d5] bg-slate-50 px-3 py-2.5 hover:bg-slate-100 transition">
