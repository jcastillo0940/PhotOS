...
Route::get('/project-invitations/{token}', [App\Http\Controllers\ProjectInvitationController::class, 'show'])->name('project.invitations.show');
Route::post('/project-invitations/{token}/accept', [App\Http\Controllers\ProjectInvitationController::class, 'accept'])->middleware('auth')->name('project.invitations.accept');
...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::middleware('studio.operator')->group(function () {
        ...
        Route::post('/projects/{project}/collaborators', [App\Http\Controllers\ProjectCollaboratorController::class, 'store'])->middleware('tenant.admin')->name('admin.projects.collaborators.store');
        Route::delete('/projects/{project}/collaborators/{collaborator}', [App\Http\Controllers\ProjectCollaboratorController::class, 'destroy'])->middleware('tenant.admin')->name('admin.projects.collaborators.destroy');
        Route::post('/projects/{project}/collaborators/{collaborator}/regenerate', [App\Http\Controllers\ProjectCollaboratorController::class, 'regenerate'])->middleware('tenant.admin')->name('admin.projects.collaborators.regenerate');
        Route::post('/projects/{project}/collaborators/{collaborator}/revoke', [App\Http\Controllers\ProjectCollaboratorController::class, 'revoke'])->middleware('tenant.admin')->name('admin.projects.collaborators.revoke');
